...
Images from a user cannot be directly displayed usign '''<img>''' because a fake file path is created. You need to convert the image to a Base64 URL, so it can be displayed and kept after page refresh.